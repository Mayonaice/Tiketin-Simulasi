            ...
            <form action="{{ route('admin.tiket.update', $tiket->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <select id="jadwal_id" name="jadwal_id" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                                ...
                                <option value="{{ $jadwal->id }}" {{ (old('jadwal_id', $tiket->jadwal_id) == $jadwal->id) ? 'selected' : '' }}>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nomor_tiket" id="nomor_tiket" value="{{ old('nomor_tiket', $tiket->nomor_tiket) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="text" name="nomor_kursi" id="nomor_kursi" value="{{ old('nomor_kursi', $tiket->nomor_kursi) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="harga" id="harga" value="{{ old('harga', $tiket->harga) }}" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="0" required>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <select id="status" name="status" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                                ...
                                <option value="dipesan" {{ old('status', $tiket->status) == 'dipesan' ? 'selected' : '' }}>Dipesan</option>
                                <option value="terjual" {{ old('status', $tiket->status) == 'terjual' ? 'selected' : '' }}>Terjual</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="keterangan" name="keterangan" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('keterangan', $tiket->keterangan) }}</textarea>
                        </div>
                        <p class="mt-2 text-sm text-gray-500">
