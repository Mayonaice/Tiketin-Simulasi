...
<div class="container mx-auto px-4">
    ...
    <div class="flex items-center text-sm text-gray-500 mb-6">
        ...
        <a href="{{ route('admin.history') }}" class="hover:text-blue-600">Riwayat Pemesanan</a>
        <svg class="h-4 w-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
        </svg>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-4">
                        <a href="{{ route('admin.history') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-md text-center transition-colors">
                            Kembali ke Daftar
                        </a>
                    </div>
                </div>
